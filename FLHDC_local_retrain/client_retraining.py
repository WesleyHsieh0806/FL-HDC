...
def client_training(client_number, dimension, level, Nof_feature,
                    PCA_Projection, nof_class, CIM_vector, IM_vector, maximum, minimum):
    ''' 
    ...
    * Dataset as "Upload.pickle" for Gloabl model
    ...
    MNIST.retrain(test_x=val_data, test_y=val_label, train_x=train_data, train_y=train_label, num_epoch=5, train_acc_demand=0.7, batch_size=len(train_data)//2, save_path=os.path.join(os.path.join(os.path.dirname(
