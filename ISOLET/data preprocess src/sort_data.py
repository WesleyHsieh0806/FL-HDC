...
if not os.path.isdir(os.path.join(file_dir, '../ISOLET/sorted_data_csv')):
    os.makedirs(os.path.join(file_dir, '../ISOLET/sorted_data_csv'))
...
train_path = os.path.join(file_dir, '../ISOLET/data_csv/train.csv')
test_path = os.path.join(file_dir, '../ISOLET/data_csv/test.csv')
...
sort_train_label_path = os.path.join(
    file_dir, '../ISOLET/sorted_data_csv/train_label.csv')
sort_test_data_path = os.path.join(
    file_dir, '../ISOLET/sorted_data_csv/test_data.csv')
sort_test_label_path = os.path.join(
    file_dir, '../ISOLET/sorted_data_csv/test_label.csv')
